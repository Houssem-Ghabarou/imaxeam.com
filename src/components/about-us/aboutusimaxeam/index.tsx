  ...
  return (
    <div className="flex flex-col gap-5 xl:gap-30   xl:mt-30 ">
      <div className="px-6 xl:px-20 2xl:px-40 flex justify-between items-center gap-20 relative  ">
        <div
          className="xl:w-[50%] 2xl:w-[55%] flex flex-col gap-4 p-8 rounded-2xl"
          style={{
      ...
      <div className="px-6 xl:px-20 2xl:px-40  flex   flex-row-reverse justify-between items-center gap-20 relative xl:mt-30 ">
        {/* <div className=" hidden xl:inline xl:w-[50%]">
          <img src="/aboutOur-Commitment.png" />
        </div> */}
        {/*  abouts 2 3*/}
        <div className=" hidden xl:inline  absolute xl:left-10 2xl:left-45 top-[-180]">
          <img src="/aboutus2.svg" width={300} />
        </div>
        <div className=" hidden xl:inline  absolute xl:left-90 2xl:left-125">
          <img src="/aboutus3.svg" width={300} />
        </div>
        <div
          className="xl:w-[50%] 2xl:w-[55%]  flex flex-col gap-4 rounded-2xl p-8"
          style={{
            background: `linear-gradient(97.4deg, rgba(238, 238, 238, 0.5) 23.21%, rgba(242, 242, 242, 0.8) 81.91%)`,
          }}
        >
